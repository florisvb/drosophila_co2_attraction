...
# for figure 1
fly_bottle_data = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/fly_bottle_co2_measurements/bottles'
fly_bottle_calibration = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/fly_bottle_co2_measurements/calibrations'

# for figure 2
freeflight_rotpad_hcs = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/windtunnel_freeflight_rotpad_hcs'
freeflight_rotpad_orco = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/windtunnel_freeflight_rotpad_orco'

# primarily for figure3
basepath_for_windtunnel_walking = '/media/caveman/CO2_hdf5/singlepad_windtunnel_blacktop/'
...
basepath_arena_activity = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/'
...
# for figure 5
walking_arena_hcs_concentration = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/low_flow_walking_arena_B_HCS_concentration'
walking_arena_symmetric_stim_genetics = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/low_flow_walking_arena_B'
walking_arena_symmetric_stim_genetics_ethanol = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/low_flow_walking_arena_B_ETHANOL'
walking_arena_symmetric_stim_genetics_vinegar = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/low_flow_walking_arena_B_VINEGAR'
walking_arena_symmetric_stim_genetics_ethanol_hcs = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/low_flow_walking_arena_B_ETHANOL/eth_hcs'
walking_arena_symmetric_stim_genetics_vinegar_hcs = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/low_flow_walking_arena_B_VINEGAR/vinegar_hcs'
walking_arena_tripleparadigm_hcs = '/media/caveman/CO2_hdf5/CO2_data_notrajecs/low_flow_walking_arena_B/hcs'
