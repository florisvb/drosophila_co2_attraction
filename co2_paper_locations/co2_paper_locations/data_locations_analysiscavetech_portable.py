...
# for figure 1
fly_bottle_data = '/media/caveman/CO2_hdf5_port2TB/CO2_data_notrajecs/fly_bottle_co2_measurements/bottles'
fly_bottle_calibration = '/media/caveman/CO2_hdf5_port2TB/CO2_data_notrajecs/fly_bottle_co2_measurements/calibrations'

# for figure 2
freeflight_rotpad_hcs = '/media/caveman/CO2_hdf5_port2TB/CO2_data_notrajecs/windtunnel_freeflight_rotpad_hcs'
freeflight_rotpad_orco = '/media/caveman/CO2_hdf5_port2TB/CO2_data_notrajecs/windtunnel_freeflight_rotpad_orco'

# primarily for figure3
basepath_for_windtunnel_walking = '/media/caveman/CO2_hdf5_port2TB/CO2_data_notrajecs/singlepad_windtunnel_blacktop/'
windtunnel_walking = {#  'orco_co260': basepath_for_windtunnl_walking+'60sccm_co2_ORCO',
                         'co2_5sccm':  basepath_for_windtunnel_walking+'5sccm_CO2',
                         'co2_60sccm': basepath_for_windtunnel_walking+'60sccm_co2_mag',
                         'eth_60sccm': basepath_for_windtunnel_walking+'60sccm_ethanol',
                         'co2_200sccm': basepath_for_windtunnel_walking+'200sccm_co2_mag',
                         #'co2_hungry': basepath_for_windtunnel_walking+'co2_hungry_60sccm',
                         'eth_200sccm': basepath_for_windtunnel_walking+'200sccm_ethanol',
                         'vinegar_15sccm': basepath_for_windtunnel_walking+'15sccm_vinegar_hcs',
                         'vinegar_60sccm': basepath_for_windtunnel_walking+'60sccm_vinegar',
                         'vinegar_200sccm': basepath_for_windtunnel_walking+'200sccm_vinegar',
                         'vinegar_60sccm_15co2': basepath_for_windtunnel_walking+'60sccm_vinegar_15sccm_co2',
                         'co2_15sccm': basepath_for_windtunnel_walking+'co2_15sccm',
                         'h2o_60sccm': basepath_for_windtunnel_walking+'h20_60sccm',
                         'ethylacetate_15sccm': basepath_for_windtunnel_walking+'ethylacetate_200ul_100ml_h20_15sccm',
                         'ethylacetate_15_50': basepath_for_windtunnel_walking+'ethacet_15sccm_50ul_in100ml_h2o',
                         'eth_15sccm': basepath_for_windtunnel_walking+'ethanol_15sccm',
                         'ethylacetate_60sccm':  basepath_for_windtunnel_walking+'ethylacetate_200ul_100ml_h20_60sccm',
                         'eth-co2_60_15': basepath_for_windtunnel_walking+'ethanol_60sccm_15sccm_co2',
                         'h2o_200sccm': basepath_for_windtunnel_walking+'h2o_200sccm',
                         'h2o_15sccm': basepath_for_windtunnel_walking+'h2o_15sccm',
                         }
                         
# primarily for figure 4
basepath_arena_activity = '/media/caveman/CO2_hdf5_port2TB/CO2_data_notrajecs/'
...
# for figure 5
walking_arena_hcs_concentration = '/media/caveman/CO2_hdf5_port2TB/CO2_data_notrajecs/low_flow_walking_arena_B_HCS_concentration'
walking_arena_symmetric_stim_genetics = '/media/caveman/CO2_hdf5_port2TB/CO2_data_notrajecs/low_flow_walking_arena_B'
