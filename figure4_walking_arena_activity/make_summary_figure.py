...
def plot_circadian():
    ...
    mcat.plot_circadian.plot_circadian(layout.axes[(u'control_circadian', u'control_circadian')], ffname_to_directory['control_dusk'])
    mcat.plot_circadian.plot_circadian(layout.axes[(u'hcs_circadian', u'hcs_circadian')], ffname_to_directory['low_flow_co2_dusk'])
    mcat.plot_circadian.plot_circadian(layout.axes[(u'starved_circadian', u'starved_circadian')], ffname_to_directory['low_flow_co2_starved_dusk'])
    mcat.plot_circadian.plot_circadian(layout.axes[(u'ethanol_circadian', u'ethanol_circadian')], ffname_to_directory['ethanol_starved_dusk'])
    ...
    axes = [layout.axes[('control_circadian_colors', 'control_circadian_colors')],
            layout.axes[('hcs_circadian_colors', 'hcs_circadian_colors')],
            layout.axes[('starved_circadian_colors', 'starved_circadian_colors')],
            layout.axes[('ethanol_circadian_colors', 'ethanol_circadian_colors')],
            ]
...
def plot_time_series_and_scatters(figurename, directory, flowrate, time_of_day, scatter_time_secs=75, speed_scatter_time=-300): # scatter_time_secs=75, speed_scatter_time=-300
    layout = get_paper_layout()
    print directory
    mcat.plot_n_flies.plot_n_flies_in_control_and_odor_regions(layout.axes[(figurename, 'nflies')], directory, time_of_day, flowrate, average_within_paths=AVERAGE_WITHIN_PATHS)
    ...
    if speed_scatter_time is not None:
        ...
        mcat.plot_n_flies.plot_raw_scatter(layout.axes[(figurename, 'speed_scatter')],             scatter_data, 'speed',              average_within_paths=False, hide_markers=True)
...
def plot_attraction_index_vs_speed():
    layout = get_paper_layout()
    ax = layout.axes['activity_correlation_relative', 'activity_correlation_relative']
...
def make_single_pulse_plots():
  ...
  mcat.plot_circadian.plot_circadian_for_tmaze_exps(layout.axes[(u'singlepulse_2hrs', u'speed')], ffname_to_directory['singlepulse_2hrs'], t_range=[0,2*60+30])
  mcat.plot_circadian.plot_circadian_for_tmaze_exps(layout.axes[(u'singlepulse_2min', u'speed')], ffname_to_directory['singlepulse_2min'], t_range=[0,30])
