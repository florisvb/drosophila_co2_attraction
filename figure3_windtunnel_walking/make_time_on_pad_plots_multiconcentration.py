...
def plot_lengths_simple(data=None):
    ...
    for x, label in enumerate(labels):
        ...
        layout.axes[('time', ff_label)].set_xlim(-0.5,0.5)
        layout.axes[('time', ff_label)].set_ylim(0, 10)
        if label == 'h2o_60sccm':
        ...
        layout.axes[('distances', ff_label)].set_ylim(0, 100)
        if label == 'h2o_60sccm':
            figurefirst.mpl_functions.adjust_spines(layout.axes[('distances', ff_label)], ['left'], yticks=[0,50,100], spine_locations={'left': 5, 'bottom': 5}, linewidth=0.5)
        ...
        layout.axes[('speeds', ff_label)].set_xlim(-0.5,0.5)
        layout.axes[('speeds', ff_label)].set_ylim(0, 4)
        if label == 'h2o_60sccm':
            figurefirst.mpl_functions.adjust_spines(layout.axes[('speeds', ff_label)], ['left'], spine_locations={'bottom': 5, 'bottom': 5}, yticks=[0,2,4], linewidth=0.5)
        ...
        layout.axes[('approaches', ff_label)].set_xlim(-0.5,0.5)
        layout.axes[('approaches', ff_label)].set_ylim(0, 10)
        if label == 'h2o_60sccm':
            figurefirst.mpl_functions.adjust_spines(layout.axes[('approaches', ff_label)], ['left'], spine_locations={'bottom': 5, 'bottom': 5}, yticks=[0,5,10], linewidth=0.5)
