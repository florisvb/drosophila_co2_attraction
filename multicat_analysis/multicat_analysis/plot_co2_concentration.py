...
def plot_co2_series_at_distance_on_ax(ax, sccm=60, distance=2, concentration=5):
    ...
    if distance == 2:
        ...
        figurefirst.deprecated_regenerate.mpl('plot',
                                 ax[0], ax[1], ax[2], fifidatafile, '2 cm distance co2 concentration',
                                ['CO2 concentration 2 cm distance',
                                 'Elevation'],
                                 mean_vals, elevations, color='red')
    elif distance == 10:
        #ax.plot(mean_vals, elevations, color='purple')
        figurefirst.deprecated_regenerate.mpl('plot',
                                 ax[0], ax[1], ax[2], fifidatafile, '10 cm distance co2 concentration',
                                ['CO2 concentration 10 cm distance',
                                 'Elevation'],
                                 mean_vals, elevations, color='purple')
...
def plot_concentration_profile(ax, distance=2, elevation=0):
    ...
    if ax is not None:
        ...
        figurefirst.deprecated_regenerate.mpl('plot',
                                 layout, figure, axis, fifidatafile, 'CO2 data ' + distance + ' ' + elevation,
                                ['Concentrations',
                                 'Mean values for calibration'],
                                 concentrations, mean_vals, 'o', color='red', markersize=3, zorder=100)
    ...
    if ax is not None:
        ...
        figurefirst.deprecated_regenerate.mpl('plot',
                                 layout, figure, axis, fifidatafile, 'correlation ' + distance + ' ' + elevation,
                                ['x value',
                                 'CO2 value'],
                                 x,y, color='red', zorder=0)
        co2_15 = model.get_val(15)
        co2_60 = model.get_val(60)
...
def plot_co2_concentration():
    ...
    ax = [layout,'co2_concentration', 'co2_concentration']
    plot_co2_series_at_distance_on_ax([layout, 'co2_concentration', 'co2_concentration'], distance=2, concentration=5)
    ...
    plot_co2_series_at_distance_on_ax([layout, 'co2_concentration', 'co2_concentration'], distance=10, concentration=5)
    xticks = [0, 1.5, 3]
    yticks = [-2, 0, 2]
    ...
    figurefirst.deprecated_regenerate.custom( 'figurefirst', 'mpl_functions.adjust_spines', ax[0], ax[1], ax[2], fifidatafile, 'adjust spines 10 cm', [], 
                              ['right', 'bottom'], xticks=xticks, yticks=yticks, spine_locations={'right': 5, 'bottom': 5}, linewidth=0.5, tick_length=2.5)
...
def plot_co2_calibration():
    ...
    def plot_it(ax, xticks, yticks):
        ...
        figurefirst.deprecated_regenerate.custom( 'figurefirst', 'mpl_functions.adjust_spines', ax[0], ax[1], ax[2], fifidatafile, 'adjust spines', [], 
                              ['left', 'bottom'], spine_locations={'left': 5, 'bottom': 5}, xticks=xticks, yticks=yticks, linewidth=0.5, tick_length=2.5)
        ...
        figurefirst.deprecated_regenerate.mpl('plot',
                                 layout, figure, axis, fifidatafile, 'co2 calibration 10 cm',
                                ['mL per min CO2',
                                 'percent CO2 in windtunnel'],
                                 5, co2_mean, 'o', color='purple', markersize=3)
        #ax.plot(xs, xs*slope_10cm+intercept, color='purple')
        figurefirst.deprecated_regenerate.mpl('plot',
                                 layout, figure, axis, fifidatafile, 'correlation 10 cm',
                                ['mL per min CO2',
                                 'percent CO2 in windtunnel'],
                                 xs, xs*slope_10cm+intercept, color='purple')
        ...
        figurefirst.deprecated_regenerate.mpl('plot',
                                 layout, figure, axis, fifidatafile, 'co2 calibration 0 cm',
                                ['mL per min CO2',
                                 'percent CO2 in windtunnel'],
                                 1, co2_mean, 'o', color='green', markersize=3)
        #ax.plot(xs, xs*slope_10cm+intercept, color='purple')
        figurefirst.deprecated_regenerate.mpl('plot',
                                 layout, figure, axis, fifidatafile, 'correlation 0 cm',
                                ['mL per min CO2',
                                 'percent CO2 in windtunnel'],
                                 xs, xs*slope_0cm+intercept, color='green')

    figurefirst.deprecated_regenerate.mpl('set_ylim', layout, 'co2_calibration', 'co2_calibration', fifidatafile, 'set_ylim', [],
                              0,30000)
    figurefirst.deprecated_regenerate.mpl('set_xlim', layout, 'co2_calibration', 'co2_calibration', fifidatafile, 'xlim', [],
                              0,70)
    plot_it([layout, 'co2_calibration', 'co2_calibration'], [0,5,15,60], [0, 10000, 20000, 30000])

    figurefirst.deprecated_regenerate.mpl('set_ylim', layout, 'co2_calibration', 'co2_calibration_zoom', fifidatafile, 'set_ylim', [],
                              0,3000)
    figurefirst.deprecated_regenerate.mpl('set_xlim', layout, 'co2_calibration', 'co2_calibration_zoom', fifidatafile, 'xlim', [],
                              0,6)
    plot_it([layout, 'co2_calibration', 'co2_calibration_zoom'],  [0, 1, 5], [0, 1000, 2000, 3000])
    ...
    figurefirst.deprecated_regenerate.custom( 'figurefirst', 'mpl_functions.set_fontsize', layout, 'co2_calibration', 'co2_calibration', fifidatafile, 'set fontsize', [], 
                                 6)
    figurefirst.deprecated_regenerate.custom( 'figurefirst', 'mpl_functions.set_fontsize', layout, 'co2_calibration', 'co2_calibration_zoom', fifidatafile, 'set fontsize zoom', [], 
                                 6)
